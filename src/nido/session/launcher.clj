...
(def ^:private shipping-doctrine-instructions
  (str "## Shipping doctrine\n"
       ...
       "| **cut** | how one change is divided into layers — what `/stack` draws and `:layers` claims | **no** — collapsed at `/land` |\n"
       ...
       "\n"
       "A layer is a **level of abstraction**, as in stratified design (Abelson\n"
       "& Sussman): each level is built from what the level below provides, and\n"
       "provides what the level above is written in.\n"
       "\n"
