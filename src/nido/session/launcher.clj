...
(def ^:private shipping-doctrine-instructions
  (str "## Shipping doctrine\n"
       ...
       "to conserve.\n"
       "\n"
       "Work is decomposed along two axes, and every unit lands in one of four\n"
       "destinations:\n"
       "\n"
       ...
       "(decay).\n"
       "\n"
       "Invoke `/stack` and `/spin-out` **at planning time**. Read only at ship\n"
       "time, either doctrine arrives after the work is already a heap.\n"))
